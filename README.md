...
- **Copy** — copies the raw EDI text to your clipboard.
...
|----------------------------|-------------------|-------|
| `Subscription number `     | Order / Item Ref  | Trailing space is significant for auto-match |
...
| `Delivery Name `           | H2 customer name  | |
...
| File Prefix | `T1` | Used in the output filename only (e.g. `T1.0027816_...`). |
| Sender Code | `BLOUK` | 4–6 character code written to $$HDR / $$EOF. |
